...
public class fl  {
	...
	public static HashMap<String,Double> station_average = new HashMap<String,Double>(); //variable to store average of the TMAX values per station
	public static ConcurrentHashMap<String,Double> station_temp = new ConcurrentHashMap<String,Double>(); //HashMap that stores sum of TMAX values per station id . key:value :: station_id : sumOfTmaxValues
	public static ConcurrentHashMap<String,Integer> station_count = new ConcurrentHashMap<String,Integer>();//HashMap that stores number of TMAX values per station id . key:value :: station_id:totalCount
	public static List<String> weatherData = new ArrayList<String>(); //hashmap containing total number of TMAX records for each station Id. key : stationId , value : total
	...
	public static void main(String[] args){
	    ...
	    for(int executionCounter=0; executionCounter<numberOfExecutions; executionCounter++){
	    	//Clearing all global hashmaps
	    	station_average.clear();
	    	station_temp.clear();
	    	station_count.clear();
	    	
	        //starting timer before execution begins
		...
		double executionTime=0;
			...
			for(int i=0 ; i<numberOfThreads; i++){
				arrayOfThreads.add(new Thread(new flSum(start,start+incrementCount,(ArrayList<String>)weatherData,station_temp, station_count,fibonacciFlag)));
			...
			//stopping counter after execution has ended
			long endTime = System.currentTimeMillis();
			
	
			
			//Computing performance meterics
		...
		pw.println("The output of fine lock program containing average TMAX value recorded per stationId");
